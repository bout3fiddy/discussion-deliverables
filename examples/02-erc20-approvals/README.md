...
A runnable demonstration of why approvals exist for ERC20 assets, and how the send-then-call pattern does the same trade without one. This is the teaching version of [change 1 (optimistic transfers)](../../README.md#1-optimistic-transfers-exchange_received) in the root README.
